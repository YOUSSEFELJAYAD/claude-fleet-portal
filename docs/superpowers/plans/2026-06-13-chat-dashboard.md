...
**Spec:** `docs/superpowers/specs/2026-06-13-chat-dashboard-design.md` · **Decisions:** DC.md §29 (D-029…D-032)
...
```typescript
/** §29 chat commands — list all add-on infos (same shape as GET /api/addons). */
...
/** §29 chat commands — enable/disable an add-on by id; returns the updated info or throws 404. */
