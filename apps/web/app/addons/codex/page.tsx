...
import { Panel, Kicker, Btn, Dot, Stat, Field, Input, Select, ErrorBanner } from '@/components/ui';
  ...
  if (err && !addon) {
    return (
      <div>
        ...
        <h1 className="font-display text-[26px] tracking-wide text-ink mt-1 mb-4">Codex Engine</h1>
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
        <div>
          ...
          <h1 className="font-display text-[26px] tracking-wide text-ink mt-1">Codex Engine</h1>
