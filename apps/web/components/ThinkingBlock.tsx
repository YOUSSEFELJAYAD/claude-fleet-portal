 ...
 *  sig-awaiting (#b08cff) keyed to the run-debugger's `thinking` color for consistency. */
  ...
  return (
    <div className="border border-line2 bg-black/40 my-1.5">
      ...
      >
        ...
        <Dot color="#b08cff" size={6} />
        <span className="font-display uppercase tracking-wider text-[10px] text-sig-awaiting">thinking</span>
